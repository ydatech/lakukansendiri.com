...
<div class="row">
	...
	<?php else:?>
	<div class="col-lg-12">
	<p class="lead" > Tidak ditemukan instruksi oleh user <strong> <?= $u?> </strong>, ayo <button type="button" class="btn btn-info navbar-btn" data-toggle="modal" data-target="#create-modal"> <i class="fa fa-pencil" aria-hidden="true"></i> Buat Instruksi Baru</button></p>
	</div>
	<?php endif;?>
</div>
<!-- /.row -->
